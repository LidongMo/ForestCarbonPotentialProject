...
var biome_4_Seed_500 = ee.FeatureCollection("users/leonidmoore/ForestBiomass/PlotsShapefiles/Biome_4_Seed_505_FinalModel");
var biome_5_Seed_500 = ee.FeatureCollection("users/leonidmoore/ForestBiomass/PlotsShapefiles/Biome_5_Seed_505_FinalModel");
var biome_6_Seed_500 = ee.FeatureCollection("users/leonidmoore/ForestBiomass/PlotsShapefiles/Biome_6_Seed_505_FinalModel");
...
var biome_12_Seed_500 = ee.FeatureCollection("users/leonidmoore/ForestBiomass/PlotsShapefiles/Biome_12_Seed_505_FinalModel");
...
var predictorImage01 = predictorImage.mask(mask01);
var predictorImage02 = predictorImage.mask(mask02);
var predictorImage04 = predictorImage.mask(mask04);
var predictorImage05 = predictorImage.mask(mask05);
var predictorImage06 = predictorImage.mask(mask06);
var predictorImage07 = predictorImage.mask(mask07);
var predictorImage08 = predictorImage.mask(mask08);
var predictorImage10 = predictorImage.mask(mask10);
var predictorImage11 = predictorImage.mask(mask11);
var predictorImage12 = predictorImage.mask(mask12);
var predictorImage13 = predictorImage.mask(mask13);
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_01',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_01_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_02',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_02_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_04',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_04_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_05',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_05_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_06',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_06_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_07',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_07_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_08',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_08_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_10',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_10_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_11',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_11_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_12',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_12_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Export.image.toAsset({
	...
	description: '20200702_Fores_Biomass_500_Asset_Biome_13',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_13_500_Final_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
var biomassMap01 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_01_500_Final_Ver06');
var biomassMap02 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_02_500_Final_Ver06');
var biomassMap04 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_04_500_Final_Ver06');
var biomassMap05 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_05_500_Final_Ver06');
var biomassMap06 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_06_500_Final_Ver06');
var biomassMap07 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_07_500_Final_Ver06');
var biomassMap08 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_08_500_Final_Ver06');
var biomassMap10 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_10_500_Final_Ver06');
var biomassMap11 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_11_500_Final_Ver06');
var biomassMap12 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_12_500_Final_Ver06');
var biomassMap13 = ee.Image('users/leonidmoore/ForestBiomass/PredictedMaps/Predicted_PresentMap_Biome_13_500_Final_Ver06');

// Map.addLayer(biomassMap1002);
var vibgYOR = ['330044', '220066', '1133cc', '33dd00', 'ffda21', 'ff6622', 'd10000'];
// Map.addLayer(biomassMap1001.updateMask(forestMask),{palette:vibgYOR,min:0, max:1000},'Prediction Map 1001');
// Map.addLayer(biomassMap1002.updateMask(forestMask),{palette:vibgYOR,min:0, max:1000},'Prediction Map 1002');
// Map.addLayer(biomassMap1003.updateMask(forestMask),{palette:vibgYOR,min:0, max:1000},'Prediction Map 1003');
// Map.addLayer(biomassMap1004.updateMask(forestMask),{palette:vibgYOR,min:0, max:1000},'Prediction Map 1004');
// Map.addLayer(compositeImage.select('GlobBiomass_AboveGroundBiomass').mask(forestMask).divide(2),{palette:vibgYOR,min:0, max:150},'GlobBiomass Map');
...
var mergedPrediction = allTypesComposite.mosaic().exp().subtract(1);


// export the raw potential density map
Export.image.toAsset({
	image: mergedPrediction,
	description: '20200702_Fores_Biomass_500_Asset_Present_Density',
	assetId: 'users/leonidmoore/ForestBiomass/PredictedMaps/PredictedMap_Present_Biomass_Density_Ver06',
	region: unboundedGeo,
  crs:'EPSG:4326',
  crsTransform:[0.008333333333333333,0,-180,0,-0.008333333333333333,90],
	maxPixels: 1e13
...
Map.addLayer(mergedPrediction,{palette:vibgYOR,min:0, max:150},'Merged Biomass Map');
var woodDensityStemBiomassMap = ee.Image("users/leonidmoore/WoodDensityProject/PredictedMaps/WoodDensityBased_Stem_Biomass_Density_Map");
Map.addLayer(woodDensityStemBiomassMap.mask(forestMask),{palette:vibgYOR,min:0, max:150},'Merged Biomass Map Wood density based');
// multiply(forestCover).divide(100)
// make pixel area image
var pixelArea = ee.Image.pixelArea().divide(10000); // to ha unit
// var absoluteImage =mergedPrediction.multiply(ee.Image.pixelArea()).divide(10000).multiply(forestCover);
var absoluteImage =mergedPrediction.multiply(ee.Image.pixelArea()).divide(1000000);
// Map.addLayer(absoluteImage,{palette:vibgYOR,min:0, max:1000000},'abs');
// print(absoluteImage);

var presentBiomassDensity = ee.Image("users/leonidmoore/Present_Global_Biomass_unmasked_seed_1000");
var potentialBiomassDensity = ee.Image("users/leonidmoore/Potential_Global_Biomass_unmasked_seed_1000");

// visulize the two maps
// denfine the color for legent
var vibgYOR = ['330044', '220066', '1133cc', '33dd00', 'ffda21', 'ff6622', 'd10000'];
// Map.addLayer(presentBiomassDensity.divide(2000).mu,{palette:vibgYOR,min:0, max:1000},'Present Biomass Density');

var sumBiomass = absoluteImage.reduceRegion({
